...
export default function HomeFeatures() {
  return (
    <section className="mt- 10 lg:mt-80">
      <div className="w-[78%] my-0 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:flex lg:flex-row justify-center items-center gap-6 lg:gap-10 lg:mb-10">
          <img className="w-[60px] mx-auto" src={home} alt="home-logo" />
          <img className="w-[60px] mx-auto" src={vs} alt="vs-brand-logo" />
          <img className="w-[60px] mx-auto" src={brand} alt="brand-logo" />
          <img className="w-[60px] mx-auto" src={nature} alt="nature-logo" />
          <img className="w-[60px] mx-auto" src={classic} alt="classic-logo" />
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 my-8 lg:my-0">
          <div className="flex flex-col gap-2 text-start">
            ...
            <p className="text-[#808080] text-start md:w-[500px]">
              ...
              complete flexibility to create even the most powerful of products.
            </p>
            <div>
        ...
        <div className="my-8">
          <header className="text-center font-bold text-2xl text-[#2F2F2F] my-2 md:my-6 lg:my-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {features.map((feature) => (
              <div
                key={feature.id}
                className="rounded border border-[#DCDCDC] p-8"
              >
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-between items-center my-1">
                    <img
                      ...
                      className="w-6"
                    />
                    <button className="hover:bg-[#5956E9]">
                      {feature.start}
                    </button>
                  </div>
                </div>
