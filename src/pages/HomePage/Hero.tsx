...
export default function Hero() {
    return (
        <div>
            <section>
                <div style={{ backgroundImage: `url(${heroBg})`, backgroundSize: "auto 1000px" }} className="w-[90%] my-0 mx-auto relative bg-cover bg-center bg-no-repeat rounded mt-4 mb-8">
