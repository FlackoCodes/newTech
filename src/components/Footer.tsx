    ...
    return (
        <footer className="w-[70%] my-0 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-6">
                <div className="border-r border-[#E0E0E0] flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="bg-[#2F2F2F] rounded-2xl grid grid-cols-2 gap-2 p-6">
                    <div className="border-r border-[#E0E0E0] grid place-content-center align-middle">
                        <button className="bg-gradient-to-r from-[#5956E9] to-[#E541ED] py-2 px-3 rounded-full text-white cursor-pointer">Click</button>
                        ...
                        <button className="bg-[#424242] text-white px-3 py-2 rounded-full cursor-pointer">Popular</button>
                    </div>
