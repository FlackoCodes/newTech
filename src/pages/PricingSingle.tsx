        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="bg-[#F6F6F6] rounded-xl p-6 md:p-8 w-full max-w-md mx-auto shadow-sm flex flex-col items-start space-y-4">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              Building an enterprise-level site doesn't need to be a nightmare
              or cost thousands.
            </p>
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed my-2">
              Building an enterprisecompletxability to create level site doesn't
              need nightmare cost your thousands. Felix is purpose built for
              ease of use and completxability to create even the most powerful
              of products.{" "}
            </p>
